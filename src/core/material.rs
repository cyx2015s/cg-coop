...
impl RaytracingMaterial {
    pub fn new(ty: i32, ior: f32, fuzz: f32, albedo: [f32; 3]) -> Self {
        Self {
            ty,
            ior,
            fuzz,
...
impl Default for RaytracingMaterial {
    fn default() -> Self {
        Self {
            ty: 0,
            ior: 1.5,
...
implement_uniform_block_new!(RaytracingMaterial, ty, ior, fuzz, _pad1, albedo, _pad2);
implement_uniform_block_new!(RaytracingMaterialBlock, material);
